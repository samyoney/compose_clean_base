...
-keep class com.example.compose_clean_base.data.model.** { *; }
-keepclasseswithmembers class com.example.compose_clean_base.data.model.** { *; }
#-keep class com.example.compose_clean_base.** { *; }
#-keepclasseswithmembers class com.example.compose_clean_base.** { *; }